         ...
         if(this.field_72587_r) {
            ...
            if(p_72498_1_.field_73546_h) {
               ...
               if(!this.field_72574_e.func_70608_bn() && (var11 > 1.65D || var11 < 0.1D)) {
                  ...
                  this.field_72573_d.func_98033_al().func_98236_b(this.field_72574_e.field_71092_bJ + " had an illegal stance: " + var11);
                  return;
               }
            ...
            this.field_72574_e.func_70080_a(this.field_72579_o, this.field_72589_p, this.field_72588_q, var13, var14);
            if(!this.field_72587_r) {
               return;
            }
            ...
            if(var25 > 100.0D && (!this.field_72573_d.func_71264_H() || !this.field_72573_d.func_71214_G().equals(this.field_72574_e.field_71092_bJ))) {
               this.field_72573_d.func_98033_al().func_98236_b(this.field_72574_e.field_71092_bJ + " moved too quickly! " + var11 + "," + var15 + "," + var17 + " (" + var19 + ", " + var21 + ", " + var23 + ")");
            ...
            if(var28 && (var31 || !var32) && !this.field_72574_e.func_70608_bn()) {
               this.func_72569_a(this.field_72579_o, this.field_72589_p, this.field_72588_q, var13, var14);
               return;
            }
         ...
         for(var5 = 0; var5 < 4; ++var5) {
            ...
            if(p_72487_1_.field_73308_d[var5].length() > 15) {
               ...
               for(var8 = 0; var8 < p_72487_1_.field_73308_d[var5].length(); ++var8) {
                  if(ChatAllowedCharacters.field_71568_a.indexOf(p_72487_1_.field_73308_d[var5].charAt(var8)) < 0) {
                     var6 = false;
                  }
               }
            }
