   ...
   protected void func_74110_b(int p_74110_1_, int p_74110_2_, float p_74110_3_) {
      ...
      for(var22 = 0; var22 < AchievementList.field_76007_e.size(); ++var22) {
         ...
         if(var37 >= -24 && var25 >= -24 && var37 <= 224 && var25 <= 155) {
            ...
            GL11.glEnable(2896);
            GL11.glEnable(2884);
            var32.func_82406_b(this.field_73882_e.field_71466_p, this.field_73882_e.field_71446_o, var33.field_75990_d, var38 + 3, var39 + 3);
            GL11.glDisable(2896);
            if(!this.field_74126_x.func_77442_b(var33)) {
      ...
      if(var30 != null) {
         String var34 = StatCollector.func_74838_a(var30.func_75970_i());
         ...
         if(this.field_74126_x.func_77442_b(var30)) {
            ...
            if(this.field_74126_x.func_77443_a(var30)) {
               this.field_73886_k.func_78261_a(StatCollector.func_74838_a("achievement.taken"), var37, var25 + var39 + 4, -7302913);
            }
         } else {
            var38 = Math.max(this.field_73886_k.func_78256_a(var34), 120);
            String var41 = StatCollector.func_74837_a("achievement.requires", new Object[]{StatCollector.func_74838_a(var30.field_75992_c.func_75970_i())});
