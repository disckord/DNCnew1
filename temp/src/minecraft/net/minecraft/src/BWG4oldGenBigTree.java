...
public class BWG4oldGenBigTree extends WorldGenerator {
   ...
   public BWG4oldGenBigTree(int var1) {
      ...
      for(var11[var5] = var10[var5]; var12 <= var7; ++var12) {
         ...
         while(var14 <= var7) {
            ...
            if(var15 > (double)var4) {
               ...
               int var17 = this.worldObj.func_72798_a(var11[0], var11[1], var11[2]);
               if(var17 != 0 && var17 != 18) {
                  ++var14;
               } else {
                  this.worldObj.func_94575_c(var11[0], var11[1], var11[2], var6);
                  ++var14;
               }
            }
         }
   ...
   void func_522_a(int[] var1, int[] var2, int var3) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            ...
            this.worldObj.func_94575_c(var14[0], var14[1], var14[2], var3);
         }
