...
import net.minecraft.src.BWG4NoisePerlinAlpha;
...
public class BWG4NoiseOctavesAlpha extends BWG4oldNoiseGenerator2 {
   ...
   public BWG4NoiseOctavesAlpha(Random var1, int var2) {
      this.field_1191_b = var2;
      this.field_1192_a = new BWG4NoisePerlinAlpha[var2];

      for(int var3 = 0; var3 < var2; ++var3) {
         this.field_1192_a[var3] = new BWG4NoisePerlinAlpha(var1);
      }
