...
public class BWG4decoBigTree extends WorldGenerator {
   ...
   public BWG4decoBigTree(int var1, int var2) {
      this.size = var1;
      this.type = var2;
   }
      ...
      for(var11[var5] = var10[var5]; var12 <= var7; ++var12) {
         ...
         while(var13 <= var7) {
            ...
            if(var14 > (double)(var4 * var4)) {
               ...
               int var16 = this.worldObj.func_72798_a(var11[0], var11[1], var11[2]);
               if(var16 != 0 && var16 != Block.field_71952_K.field_71990_ca) {
                  ++var13;
               } else {
                  this.func_76485_a(this.worldObj, var11[0], var11[1], var11[2], var6, 0);
                  ++var13;
               }
            }
         }
   ...
   void generateLeafNode(int var1, int var2, int var3) {
      ...
      for(int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4) {
         ...
         this.genTreeLayer(var1, var4, var3, var6, (byte)1, Block.field_71952_K.field_71990_ca);
      }
   ...
   void placeBlockLine(int[] var1, int[] var2, int var3) {
      ...
      if(var4[var6] != 0) {
         ...
         for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
            var14[var6] = MathHelper.func_76128_c((double)(var1[var6] + var15) + 0.5D);
            var14[var7] = MathHelper.func_76128_c((double)var1[var7] + (double)var15 * var10 + 0.5D);
            var14[var8] = MathHelper.func_76128_c((double)var1[var8] + (double)var15 * var12 + 0.5D);
            byte var17 = 0;
            ...
            this.func_76485_a(this.worldObj, var14[0], var14[1], var14[2], var3, var17);
         }
      }
   ...
   void generateTrunk() {
      ...
      this.placeBlockLine(var5, var6, Block.field_71951_J.field_71990_ca);
      if(this.trunkSize == 2) {
         ++var5[0];
         ++var6[0];
         this.placeBlockLine(var5, var6, Block.field_71951_J.field_71990_ca);
   ...
   void generateLeafNodeBases() {
      ...
      for(int[] var3 = new int[]{this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1) {
         ...
         if(this.leafNodeNeedsBase(var6)) {
            this.placeBlockLine(var3, var5, (byte)Block.field_71951_J.field_71990_ca);
         }
      }
   ...
   int checkBlockLine(int[] var1, int[] var2) {
      ...
      if(var3[var5] == 0) {
         ...
         for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
            ...
            int var16 = this.worldObj.func_72798_a(var13[0], var13[1], var13[2]);
            if(var16 != 0 && var16 != Block.field_71952_K.field_71990_ca) {
               break;
            }
         }
   ...
   boolean validTreeLocation() {
      ...
      int var3 = this.worldObj.func_72798_a(this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
      if(var3 != 2 && var3 != 3) {
         return false;
      } else {
