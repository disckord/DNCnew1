...
public class NetClientHandler extends NetHandler {
   ...
   public void func_72511_a(Packet23VehicleSpawn p_72511_1_) {
      ...
      if(p_72511_1_.field_73527_h == 10) {
         ...
         while(var12.hasNext()) {
            ...
            if(p_72511_1_.field_73527_h == var10.id) {
               var8 = var10.mod.spawnEntity(p_72511_1_.field_73527_h, this.field_72564_i, var2, var4, var6);
               break;
            }
         }
      }
      ...
      if(var8 != null) {
         ...
         Entity[] var13 = ((Entity)var8).func_70021_al();
         if(var13 != null) {
            int var14 = p_72511_1_.field_73526_a - ((Entity)var8).field_70157_k;

            for(int var11 = 0; var11 < var13.length; ++var11) {
               var13[var11].field_70157_k += var14;
            }
         }
         ...
         if(p_72511_1_.field_73528_i > 0) {
            if(p_72511_1_.field_73527_h == 60) {
               Entity var15 = this.func_72545_a(p_72511_1_.field_73528_i);
               if(var15 instanceof EntityLiving) {
                  EntityArrow var16 = (EntityArrow)var8;
                  var16.field_70250_c = var15;
               }
            }
   ...
   public void func_72460_a(Packet17Sleep p_72460_1_) {
      ...
      if(var2 != null && p_72460_1_.field_73622_e == 0) {
   ...
   public void func_72516_a(Packet100OpenWindow p_72516_1_) {
      ...
      case 2:
         ...
         if(p_72516_1_.field_94500_e) {
            var3.func_94129_a(p_72516_1_.field_73430_c);
         }

         var2.func_71042_a(var3);
         var2.field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
         break;
      case 3:
         TileEntityDispenser var4 = new TileEntityDispenser();
         if(p_72516_1_.field_94500_e) {
            var4.func_94049_a(p_72516_1_.field_73430_c);
         }

         var2.func_71006_a(var4);
         var2.field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
         break;
      case 4:
      ...
      case 7:
         ...
         var2.func_82240_a(var6);
         if(p_72516_1_.field_94500_e) {
            var6.func_94047_a(p_72516_1_.field_73430_c);
         }
      ...
      case 9:
         ...
         if(p_72516_1_.field_94500_e) {
            var7.func_96115_a(p_72516_1_.field_73430_c);
         }

         var2.func_94064_a(var7);
         var2.field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
         break;
      case 10:
         TileEntityDropper var8 = new TileEntityDropper();
         if(p_72516_1_.field_94500_e) {
            var8.func_94049_a(p_72516_1_.field_73430_c);
         }

         var2.func_71006_a(var8);
         var2.field_71070_bA.field_75152_c = p_72516_1_.field_73431_a;
      default:
      ...
      if(this.field_72563_h.field_71441_e.func_72899_e(p_72468_1_.field_73334_a, p_72468_1_.field_73332_b, p_72468_1_.field_73333_c)) {
         ...
         if(var2 != null) {
            if(p_72468_1_.field_73330_d == 1 && var2 instanceof TileEntityMobSpawner) {
               ...
               var2.func_70307_a(p_72468_1_.field_73331_e);
            } else if(p_72468_1_.field_73330_d == 255) {
               if(p_72468_1_.field_73331_e == null) {
                  return;
               }

               String var3 = p_72468_1_.field_73331_e.func_74779_i("id");
