...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   ...
   public EntityPlayerMP(MinecraftServer p_i3396_1_, World p_i3396_2_, String p_i3396_3_, ItemInWorldManager p_i3396_4_) {
      ...
      if(!p_i3396_2_.field_73011_w.field_76576_e && p_i3396_2_.func_72912_H().func_76077_q() != EnumGameType.ADVENTURE) {
         if(p_i3396_2_.func_72912_H().func_76067_t() != WorldType.BWG4INDEV1 && p_i3396_2_.func_72912_H().func_76067_t() != WorldType.BWG4INDEV2) {
            if(p_i3396_2_.func_72912_H().func_76067_t() == WorldType.BWG4SKYBLOCK) {
               var8 = 84;
               var7 = 0;
               var6 = 0;
            } else {
            ...
            var8 = p_i3396_2_.func_72825_h(var6, var7) + 1;
         }
      }
   ...
   public void func_71111_a(Container p_71111_1_, int p_71111_2_, ItemStack p_71111_3_) {
      if(!(p_71111_1_.func_75139_a(p_71111_2_) instanceof SlotCrafting) && !this.field_71137_h) {
   ...
   public void func_71064_a(StatBase p_71064_1_, int p_71064_2_) {
      if(p_71064_1_ != null && !p_71064_1_.field_75972_f) {
