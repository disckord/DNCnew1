...
public class BWG4decoHugeCaves extends MapGenBase {
   ...
   protected void generateLargeCaveNode(long var1, int var3, int var4, byte[] var5, double var6, double var8, double var10) {
      this.generateCaveNode(var1, var3, var4, var5, var6, var8, var10, 1.0F + this.field_75038_b.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
   }
   ...
   protected void generateCaveNode(long var1, int var3, int var4, byte[] var5, double var6, double var8, double var10, float var12, float var13, float var14, int var15, int var16, double var17) {
      ...
      for(boolean var28 = var25.nextInt(6) == 0; var15 < var16; ++var15) {
         ...
         if(!var62 && var15 == var27 && var12 > 1.0F && var16 > 0) {
            this.generateCaveNode(var25.nextLong(), var3, var4, var5, var6, var8, var10, var25.nextFloat() * 0.5F + 0.5F, var13 - 1.5707964F, var14 / 3.0F, var15, var16, 1.0D);
            this.generateCaveNode(var25.nextLong(), var3, var4, var5, var6, var8, var10, var25.nextFloat() * 0.5F + 0.5F, var13 + 1.5707964F, var14 / 3.0F, var15, var16, 1.0D);
            return;
         }
         ...
         if(var62 || var25.nextInt(4) != 0) {
            ...
            if(var6 >= var19 - 16.0D - var29 * 2.0D && var10 >= var21 - 16.0D - var29 * 2.0D && var6 <= var19 + 16.0D + var29 * 2.0D && var10 <= var21 + 16.0D + var29 * 2.0D) {
               int var43 = MathHelper.func_76128_c(var6 - var29) - var3 * 16 - 1;
               int var44 = MathHelper.func_76128_c(var6 + var29) - var3 * 16 + 1;
               int var45 = MathHelper.func_76128_c(var8 - var31) - 1;
               int var46 = MathHelper.func_76128_c(var8 + var31) + 1;
               int var47 = MathHelper.func_76128_c(var10 - var29) - var4 * 16 - 1;
               int var48 = MathHelper.func_76128_c(var10 + var29) - var4 * 16 + 1;
               if(var43 < 0) {
                  var43 = 0;
               }
                  ...
                  for(int var52 = var47; !var49 && var52 < var48; ++var52) {
                     for(int var53 = var46 + 1; !var49 && var53 >= var45 - 1; --var53) {
                        ...
                        if(var53 >= 0 && var53 < 128) {
                           if(var5[var51] == Block.field_71942_A.field_71990_ca || var5[var51] == Block.field_71943_B.field_71990_ca) {
                              var49 = true;
                           }
                        ...
                        if(var63 * var63 + var54 * var54 < 1.0D) {
                           for(int var58 = var46 - 1; var58 >= var45; --var58) {
                              ...
                              if(var59 > -0.7D && var63 * var63 + var59 * var59 + var54 * var54 < 1.0D) {
                                 ...
                                 if(var61 == Block.field_71980_u.field_71990_ca) {
                                    var57 = true;
                                 }

                                 if(var61 == Block.field_71981_t.field_71990_ca || var61 == Block.field_71979_v.field_71990_ca || var61 == Block.field_71980_u.field_71990_ca) {
                                    if(var58 < 10) {
                                       var5[var56] = (byte)Block.field_71944_C.field_71990_ca;
                                    } else {
                                       var5[var56] = 0;
                                       if(var57 && var5[var56 - 1] == Block.field_71979_v.field_71990_ca) {
                                          var5[var56 - 1] = this.field_75039_c.func_72807_a(var50 + var3 * 16, var51 + var4 * 16).field_76752_A;
                                       }
                                    }
                                 }
                              }
   ...
   protected void func_75037_a(World var1, int var2, int var3, int var4, int var5, byte[] var6) {
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         ...
         if(this.field_75038_b.nextInt(4) == 0) {
            this.generateLargeCaveNode(this.field_75038_b.nextLong(), var4, var5, var6, var9, var11, var13);
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            this.generateCaveNode(this.field_75038_b.nextLong(), var4, var5, var6, var9, var11, var13, var19, var17, var18, 0, 0, 1.0D);
         }
      }
