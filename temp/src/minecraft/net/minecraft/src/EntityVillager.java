   ...
   private void func_70950_c(int p_70950_1_) {
      ...
      case 1:
         ...
         if(this.field_70146_Z.nextFloat() < this.func_82188_j(0.07F)) {
            ...
            var3 = 2 + this.field_70146_Z.nextInt(5 + var10 * 10) + 3 * var10;
            var2.add(new MerchantRecipe(new ItemStack(Item.field_77760_aL), new ItemStack(Item.field_77817_bH, var3), var11));
         }
         break;
      case 2:
         ...
         int[] var4 = new int[]{Item.field_77716_q.field_77779_bT, Item.field_77718_z.field_77779_bT, Item.field_77822_ae.field_77779_bT, Item.field_77798_ai.field_77779_bT, Item.field_77708_h.field_77779_bT, Item.field_77675_C.field_77779_bT, Item.field_77696_g.field_77779_bT, Item.field_77674_B.field_77779_bT};
         int[] var5 = var4;
