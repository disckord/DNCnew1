...
import net.minecraft.src.BWG4decoIndevHouse;
...
public class WorldServer extends World {
      ...
      while(var3.hasNext()) {
         ...
         if(this.field_73012_v.nextInt(16) == 0) {
            ...
            if(this.func_72896_J()) {
               BiomeGenBase var13 = this.func_72807_a(var9 + var5, var10 + var6);
               if(var13.func_76738_d()) {
                  var12 = this.func_72798_a(var9 + var5, var11 - 1, var10 + var6);
                  if(var12 != 0) {
                     Block.field_71973_m[var12].func_71892_f(this, var9 + var5, var11 - 1, var10 + var6);
                  }
               }
            }
         }
         ...
         this.field_72984_F.func_76318_c("tickTiles");
         ExtendedBlockStorage[] var21 = var7.func_76587_i();
         var9 = var21.length;

         for(var10 = 0; var10 < var9; ++var10) {
            ExtendedBlockStorage var14 = var21[var10];
            if(var14 != null && var14.func_76675_b()) {
               for(int var15 = 0; var15 < 3; ++var15) {
                  this.field_73005_l = this.field_73005_l * 3 + 1013904223;
                  var12 = this.field_73005_l >> 2;
                  int var16 = var12 & 15;
                  int var17 = var12 >> 8 & 15;
                  int var18 = var12 >> 16 & 15;
                  int var19 = var14.func_76656_a(var16, var18, var17);
                  ++var2;
                  Block var20 = Block.field_71973_m[var19];
                  if(var20 != null && var20.func_71881_r()) {
                     ++var1;
                     var20.func_71847_b(this, var16 + var5, var18 + var14.func_76662_d(), var17 + var6, this.field_73012_v);
                  }
               }
            }
         }
   ...
   public boolean func_72955_a(boolean p_72955_1_) {
      ...
      if(var2 != this.field_73064_N.size()) {
         ...
         for(int var4 = 0; var4 < var2; ++var4) {
            var3 = (NextTickListEntry)this.field_73065_O.first();
            if(!p_72955_1_ && var3.field_77180_e > this.field_72986_A.func_82573_f()) {
               break;
            }

            this.field_73065_O.remove(var3);
         ...
         while(var14.hasNext()) {
            ...
            var14.remove();
            byte var5 = 0;
            if(this.func_72904_c(var3.field_77183_a - var5, var3.field_77181_b - var5, var3.field_77182_c - var5, var3.field_77183_a + var5, var3.field_77181_b + var5, var3.field_77182_c + var5)) {
               int var6 = this.func_72798_a(var3.field_77183_a, var3.field_77181_b, var3.field_77182_c);
               if(var6 > 0 && Block.func_94329_b(var6, var3.field_77179_d)) {
                  try {
                     Block.field_71973_m[var6].func_71847_b(this, var3.field_77183_a, var3.field_77181_b, var3.field_77182_c, this.field_73012_v);
                     ...
                     int var10;
                     try {
                        var10 = this.func_72805_g(var3.field_77183_a, var3.field_77181_b, var3.field_77182_c);
                     } catch (Throwable var12) {
                        var10 = -1;
                     }

                     CrashReportCategory.func_85068_a(var9, var3.field_77183_a, var3.field_77181_b, var3.field_77182_c, var6, var10);
                     throw new ReportedException(var8);
                  }
               }
            } else {
               this.func_72836_a(var3.field_77183_a, var3.field_77181_b, var3.field_77182_c, var3.field_77179_d, 0);
            }
         }
   ...
   protected void func_73052_b(WorldSettings p_73052_1_) {
      if(!this.field_73011_w.func_76567_e()) {
         ...
         int var8 = 0;
         boolean var9 = this.field_73011_w.mayRandSpawn();
         if(var5 != null) {
         ...
         if(var9) {
            ...
            this.field_72986_A.func_76081_a(0, var7, 0);
         }

         this.field_72987_B = false;
         if(p_73052_1_.func_77165_h() == WorldType.BWG4INDEV1 || p_73052_1_.func_77165_h() == WorldType.BWG4INDEV2) {
            byte var11 = 1;
            String var12 = "";
            String var13 = "1";
            String var14 = "2";
            ...
            String var16 = "4";
            String var17 = "5";
            String var18 = p_73052_1_.func_82749_j();
            if(var18.equals(var12)) {
               var11 = 0;
            }

            if(var18.equals(var13)) {
               var11 = 1;
            }
            ...
            if(var11 == 2) {
               this.createIndevHouse(2);
            } else {
               this.createIndevHouse(1);
            }
         }
   ...
   protected void createIndevHouse(int var1) {
      int var2 = this.field_72986_A.func_76079_c();
      int var3 = this.field_72986_A.func_76074_e();
      int var4 = this.func_72825_h(var2, var3);
      (new BWG4decoIndevHouse(var1)).func_76484_a(this, this.field_73012_v, var2, var4, var3);
   }
