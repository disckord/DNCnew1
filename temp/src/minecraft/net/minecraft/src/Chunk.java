...
public class Chunk {
   ...
   private void func_76615_h(int p_76615_1_, int p_76615_2_, int p_76615_3_) {
      ...
      if(var5 != var4) {
         ...
         if(!this.field_76637_e.field_73011_w.field_76576_e) {
            ...
            if(var5 < var4) {
               for(var8 = var5; var8 < var4; ++var8) {
                  var10 = this.field_76652_q[var8 >> 4];
                  if(var10 != null) {
                     var10.func_76657_c(p_76615_1_, var8 & 15, p_76615_3_, 15);
               ...
               for(var8 = var4; var8 < var5; ++var8) {
                  var10 = this.field_76652_q[var8 >> 4];
                  if(var10 != null) {
                     var10.func_76657_c(p_76615_1_, var8 & 15, p_76615_3_, 0);
                     this.field_76637_e.func_72902_n((this.field_76635_g << 4) + p_76615_1_, var8, (this.field_76647_h << 4) + p_76615_3_);
                  }
               }
            }
            ...
            while(var5 > 0 && var8 > 0) {
               --var5;
               var9 = this.func_76596_b(p_76615_1_, var5, p_76615_3_);
               if(var9 == 0) {
                  var9 = 1;
               }
               ...
               ExtendedBlockStorage var11 = this.field_76652_q[var5 >> 4];
               if(var11 != null) {
                  var11.func_76657_c(p_76615_1_, var5 & 15, p_76615_3_, var8);
               }
            }
         }
         ...
         if(!this.field_76637_e.field_73011_w.field_76576_e) {
            this.func_76609_d(var6 - 1, var7, var9, var12);
            this.func_76609_d(var6 + 1, var7, var9, var12);
            this.func_76609_d(var6, var7 - 1, var9, var12);
            this.func_76609_d(var6, var7 + 1, var9, var12);
            this.func_76609_d(var6, var7, var9, var12);
         }
   ...
   public void func_76607_a(byte[] p_76607_1_, int p_76607_2_, int p_76607_3_, boolean p_76607_4_) {
      ...
      for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
         if((p_76607_2_ & 1 << var7) != 0 && this.field_76652_q[var7] != null) {
            var11 = this.field_76652_q[var7].func_76669_j();
            System.arraycopy(p_76607_1_, var5, var11.field_76585_a, 0, var11.field_76585_a.length);
            var5 += var11.field_76585_a.length;
         }
      }

      for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
         if((p_76607_2_ & 1 << var7) != 0 && this.field_76652_q[var7] != null) {
            var11 = this.field_76652_q[var7].func_76661_k();
            System.arraycopy(p_76607_1_, var5, var11.field_76585_a, 0, var11.field_76585_a.length);
            var5 += var11.field_76585_a.length;
         }
      }
      ...
      if(var6) {
         for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
            if((p_76607_2_ & 1 << var7) != 0 && this.field_76652_q[var7] != null) {
               var11 = this.field_76652_q[var7].func_76671_l();
               System.arraycopy(p_76607_1_, var5, var11.field_76585_a, 0, var11.field_76585_a.length);
               var5 += var11.field_76585_a.length;
            }
         }
      ...
      for(var7 = 0; var7 < this.field_76652_q.length; ++var7) {
         if((p_76607_3_ & 1 << var7) != 0) {
            if(this.field_76652_q[var7] == null) {
               ...
               var11 = this.field_76652_q[var7].func_76660_i();
               if(var11 == null) {
                  var11 = this.field_76652_q[var7].func_76667_m();
               }
