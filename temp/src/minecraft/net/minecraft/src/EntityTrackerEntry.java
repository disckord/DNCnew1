      ...
      if(this.field_73132_a instanceof EntityItem) {
         ...
         if(this.field_73132_a instanceof EntityFishHook) {
            ...
            if(this.field_73132_a instanceof EntityFireball) {
               EntityFireball var8 = (EntityFireball)this.field_73132_a;
               var1 = null;
               byte var10 = 63;
               ...
               if(var8.field_70235_a != null) {
                  var1 = new Packet23VehicleSpawn(this.field_73132_a, var10, ((EntityFireball)this.field_73132_a).field_70235_a.field_70157_k);
               } else {
                  var1 = new Packet23VehicleSpawn(this.field_73132_a, var10, 0);
               }

               var1.field_73523_e = (int)(var8.field_70232_b * 8000.0D);
               var1.field_73520_f = (int)(var8.field_70233_c * 8000.0D);
               var1.field_73521_g = (int)(var8.field_70230_d * 8000.0D);
               return var1;
