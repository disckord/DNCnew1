...
public class MapGenBase {
   ...
   public void func_75036_a(IChunkProvider p_75036_1_, World p_75036_2_, int p_75036_3_, int p_75036_4_, byte[] p_75036_5_) {
      ...
      long var7 = this.field_75038_b.nextLong() / 2L * 2L + 1L;
      long var9 = this.field_75038_b.nextLong() / 2L * 2L + 1L;

      for(int var11 = p_75036_3_ - var6; var11 <= p_75036_3_ + var6; ++var11) {
         for(int var12 = p_75036_4_ - var6; var12 <= p_75036_4_ + var6; ++var12) {
            this.field_75038_b.setSeed((long)var11 * var7 + (long)var12 * var9 ^ this.field_75039_c.func_72905_C());
            this.func_75037_a(this.field_75039_c, var11, var12, p_75036_3_, p_75036_4_, p_75036_5_);
         }
      }
