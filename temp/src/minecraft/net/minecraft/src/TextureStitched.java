...
public class TextureStitched implements Icon {
   ...
   public static TextureStitched func_94220_a(String p_94220_0_) {
      TextureStitched var1 = ModLoader.getCustomAnimationLogic(p_94220_0_);
      return (TextureStitched)(var1 != null?var1:("clock".equals(p_94220_0_)?new TextureClock():("compass".equals(p_94220_0_)?new TextureCompass():new TextureStitched(p_94220_0_))));
   }
