...
public abstract class JsonNode {
   ...
   public final Boolean getBooleanValue(Object ... p_getBooleanValue_1_) {
      return (Boolean)this.func_74613_a(JsonNodeSelectors.func_98315_c(p_getBooleanValue_1_), this, p_getBooleanValue_1_);
   }
   ...
   public final String getNumberValue(Object ... p_getNumberValue_1_) {
      return (String)this.func_74613_a(JsonNodeSelectors.func_98316_b(p_getNumberValue_1_), this, p_getNumberValue_1_);
   }

   public final boolean isArrayNode(Object ... p_isArrayNode_1_) {
      return JsonNodeSelectors.func_74683_b(p_isArrayNode_1_).func_74688_a(this);
   }
