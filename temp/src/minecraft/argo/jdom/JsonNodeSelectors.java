...
import argo.jdom.JsonNodeSelectors_Boolean;
import argo.jdom.JsonNodeSelectors_Element;
import argo.jdom.JsonNodeSelectors_Field;
import argo.jdom.JsonNodeSelectors_Number;
...
public final class JsonNodeSelectors {
   ...
   public static JsonNodeSelector func_98316_b(Object ... p_98316_0_) {
      return func_74677_a(p_98316_0_, new JsonNodeSelector(new JsonNodeSelectors_Number()));
   }

   public static JsonNodeSelector func_98315_c(Object ... p_98315_0_) {
      return func_74677_a(p_98315_0_, new JsonNodeSelector(new JsonNodeSelectors_Boolean()));
   }
