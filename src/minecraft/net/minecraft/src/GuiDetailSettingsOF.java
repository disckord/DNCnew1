...
public class GuiDetailSettingsOF extends GuiScreen
{
	...
	private static EnumOptions[] enumOptions = new EnumOptions[] { EnumOptions.CLOUDS, EnumOptions.CLOUD_HEIGHT,
			EnumOptions.TREES, EnumOptions.GRASS, EnumOptions.WATER, EnumOptions.RAIN, EnumOptions.SKY,
			EnumOptions.STARS, EnumOptions.SUN_MOON, EnumOptions.SHOW_CAPES, EnumOptions.DEPTH_FOG,
			EnumOptions.HELD_ITEM_TOOLTIPS, EnumOptions.DROPPED_ITEMS, EnumOptions.ALPHATEXTURES, EnumOptions.ALPHAFOLIAGE,  EnumOptions.OLDCHESTS, EnumOptions.CLEARGLASS, };
