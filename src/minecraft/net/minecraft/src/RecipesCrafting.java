...
public class RecipesCrafting
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
      ...
      //  par1CraftingManager.addRecipe(new ItemStack(Block.enderChest), new Object[] {"###", "#E#", "###", '#', Block.obsidian, 'E', Item.eyeOfEnder});
        ...
        par1CraftingManager.addRecipe(new ItemStack(Block.fenceIron, 6), new Object[] {"###", "###", '#', Item.ingotIron});
        par1CraftingManager.addRecipe(new ItemStack(Block.thinGlass, 6), new Object[] {"###", "###", '#', Block.glass});
