...
public class WorldServer extends World
{
    ...
    //TODO create particle Packet
    public void spawnParticlePacket(String type, double x, double y, double z, double vx, double vy, double vz)
    {
    	//System.out.println("WorldServer Particle packet spawn event triggered at: X:" + x + " Y:" + y + " Z:" + z );
    	
    	Packet63WorldParticles particlePacket = new Packet63WorldParticles(type, x, y, z, vx, vy, vz);
    	
    	for(int i = 0; i < this.playerEntities.size(); i++)
    	{
    		EntityPlayerMP currentPlayer = (EntityPlayerMP) this.playerEntities.get(i);
    		currentPlayer.playerNetServerHandler.sendPacketToPlayer(particlePacket);
    	}
    ...
    protected void createSpawnPosition(WorldSettings par1WorldSettings)
    {
        ...
        else
        {
            ...
            int var8 = 0;
            boolean var9 = this.provider.mayRandSpawn();
            ...
            if (par1WorldSettings.getTerrainType() == WorldType.BWG4INDEV1 || par1WorldSettings.getTerrainType() == WorldType.BWG4INDEV2)
            {
                ...
                String var16 = "4";
                String var17 = "5";
                String var18 = par1WorldSettings.func_82749_j();
    ...
    {
        int var2 = this.worldInfo.getSpawnX();
        int var3 = this.worldInfo.getSpawnZ();
        int var4 = this.getTopSolidOrLiquidBlock(var2, var3);
        (new BWG4decoIndevHouse(var1)).generate(this, this.rand, var2, var4, var3);
    }
    ...
    {
    //	System.out.println("WorldServer Particle spawn event triggered at: X:" + x + " Y:" + y + " Z:" + z );
