...
public class BlockTallGrass extends BlockFlower
{
    ...
    private static final String[] alphaGrassTypes = new String[] {"deadbush", "alpha_tallgrass", "alpha_fern"};
    private Icon[] iconArray;
    private Icon[] alphaIconArray;
    ...
    {int i;
        ...
        for ( i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = par1IconRegister.registerIcon(grassTypes[i]);
        }
        this.alphaIconArray = new Icon[alphaGrassTypes.length];

        for ( i = 0; i < this.iconArray.length; ++i)
        {
            this.alphaIconArray[i] = par1IconRegister.registerIcon(alphaGrassTypes[i]);
        }
    }
}
