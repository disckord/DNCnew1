...
public class RecipesWeapons
{
    ...
    public RecipesWeapons()
    {
        this.recipeItems = new Object[][] {{Block.planks, Block.cobblestone, Item.ingotIron, Item.diamond, Item.ingotGold, Block.wood, Block.stone, Block.blockIron, Block.blockDiamond, Block.blockGold},
        									{Item.swordWood, Item.swordStone, Item.swordIron, Item.swordDiamond, Item.swordGold, Item.swordHARDWOOD, Item.swordHARDSTONE, Item.swordHARDIRON, Item.swordHARDDIAMOND, Item.swordHARDGOLD}};
    }
