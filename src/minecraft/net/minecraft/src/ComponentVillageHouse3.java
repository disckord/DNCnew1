...
public class ComponentVillageHouse3 extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.glass.blockID, 0, 8, 2, 7, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.glass.blockID, 0, 8, 2, 8, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.glass.blockID, 0, 2, 2, 7, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.glass.blockID, 0, 2, 2, 8, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.glass.blockID, 0, 5, 4, 10, par3StructureBoundingBox);
