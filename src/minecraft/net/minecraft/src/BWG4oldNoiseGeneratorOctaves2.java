...
public class BWG4oldNoiseGeneratorOctaves2 extends NoiseGenerator
{
    private BWG4oldNoiseGenerator2[] field_4234_a;
    private int field_4233_b;

    public BWG4oldNoiseGeneratorOctaves2(Random var1, int var2)
    {
        this.field_4233_b = var2;
        this.field_4234_a = new BWG4oldNoiseGenerator2[var2];

        for (int var3 = 0; var3 < var2; ++var3)
        {
            this.field_4234_a[var3] = new BWG4oldNoiseGenerator2(var1);
        }
    }
