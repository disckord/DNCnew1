...
public class EntityRenderer
{
    ...
    private void renderHand(float par1, int par2)
    {
        if (this.debugViewDirection <= 0)
        {
            ...
            if ((double)Shaders.configHandDepthMul != 1.0D)
            {
                GL11.glScaled(1.0D, 1.0D, (double)Shaders.configHandDepthMul);
            }
            ...
            if (!Shaders.isCompositeRendered && this.mc.gameSettings.thirdPersonView == 0 && !this.mc.renderViewEntity.isPlayerSleeping() && !this.mc.gameSettings.hideGUI && !this.mc.playerController.enableEverythingIsScrewedUpMode())
            {
    ...
    private void updateLightmap(float par1)
    {
        ...
        if (var2 != null)
        {
            for (int var3 = 0; var3 < 256; ++var3)
            {
                ...
                float skyBrightness = var2.provider.lightBrightnessTable[var3 / 16] * (var2.getSunBrightness(1.0F));
                float blockBrightness = var2.provider.lightBrightnessTable[var3 % 16] ;
             
                if(skyBrightness > blockBrightness)
                {
                	blockBrightness = skyBrightness;
                }
                if (var2.lastLightningBolt > 0)
                {
                    skyBrightness = var2.provider.lightBrightnessTable[var3 / 16];
                }

               
               
             
                blockBrightness = blockBrightness * 0.96F + 0.03F;
                ...
                if (this.field_82831_U > 0.0F)
                {
                    ...
                    blockBrightness = blockBrightness * (1.0F - var16) + blockBrightness * 0.6F * var16;
                ...
                if (var2.provider.dimensionId == 1)
                {
                    ...
                    blockBrightness = 0.25F + blockBrightness * 0.75F;
                }
                ...
                if (this.mc.thePlayer.isPotionActive(Potion.nightVision))
                {
                    ...
                    var17 = 1.0F / blockBrightness;

                    if (var17 > 1.0F / blockBrightness)
                    {
                        var17 = 1.0F / blockBrightness;
                    }

                    blockBrightness = blockBrightness * (1.0F - var16) + blockBrightness * var17 * var16;
                }

                if (blockBrightness > 1.0F)
                {
                ...
                var17 = 1.0F - blockBrightness;
                float var18 = 1.0F - blockBrightness;
                ...
                if (blockBrightness < 0.0F)
                {
                    blockBrightness = 0.0F;
                }
                short var20 = 255;
                int var21 = (int)(blockBrightness * 255.0F);
             
                this.lightmapColors[var3] = var20 << 24 | var21 << 16 | var21 << 8 | var21;
            }
...
*/
    ...
    {
        this.mc.mcProfiler.startSection("beginRender");
        Shaders.beginRender(this.mc, par1, par2);
        this.mc.mcProfiler.endStartSection("lightTex");
        ...
        if (!Shaders.isShadowPass)
        {
            ...
            Frustrum var13 = new Frustrum();
            var13.setPosition(var7, var9, var11);
            this.mc.renderGlobal.clipRenderersByFrustum(var13, par1);
            this.mc.mcProfiler.endStartSection("updatechunks");

            while (!this.mc.renderGlobal.updateRenderers(var4, false) && par2 != 0L)
            {
                long var14 = par2 - System.nanoTime();

                if (var14 < 0L || var14 > 1000000000L)
                {
                    break;
                }
            }
        ...
        for (int var18 = 0; var18 < 2; ++var18)
        {
            ...
            Shaders.beginRenderPass(this.mc, par1, par2);
            GL11.glEnable(GL11.GL_CULL_FACE);
            ...
            if (this.debugViewDirection == 0)
            {
                ...
                {
                    var16 = (EntityPlayer)var4;
                    GL11.glDisable(GL11.GL_ALPHA_TEST);
                    this.mc.mcProfiler.endStartSection("outline");

                    if (!var15 || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, new Object[] {var5, var16, this.mc.objectMouseOver, Integer.valueOf(0), var16.inventory.getCurrentItem(), Float.valueOf(par1)}))
                    {
                        var5.drawBlockBreaking(var16, this.mc.objectMouseOver, 0, var16.inventory.getCurrentItem(), par1);

                        if (!this.mc.gameSettings.hideGUI)
                        {
                            var5.drawSelectionBox(var16, this.mc.objectMouseOver, 0, var16.inventory.getCurrentItem(), par1);
                        }
                    }
            ...
            if (!Shaders.isShadowPass && this.cameraZoom == 1.0D)
            {
            ...
            if (var15)
            {
                Shaders.bindNormalMap(Shaders.defaultTextureIdArray);
            ...
            if (!Shaders.isShadowPass)
            {
                this.mc.mcProfiler.endStartSection("composite");
                Shaders.renderCompositeFinal();
                this.mc.mcProfiler.endStartSection("overlay");
                Shaders.beginFPOverlay();
                this.renderHand(par1, var18);
                Shaders.endFPOverlay();
            }

            this.mc.mcProfiler.endStartSection("endRender");
            Shaders.endRender();
            GL11.glColorMask(true, true, true, true);

            if (!this.mc.gameSettings.anaglyph || Shaders.isShadowPass)
            {
                break;
            }
        }
                ...
                if (var19 <= var5 + var7 && var19 >= var5 - var7 && var21.canSpawnLightningBolt() && var21.getFloatTemperature() >= 0.2F)
                {
                    ...
                    if (var20 > 0)
                    {
                        if (Block.blocksList[var20].blockMaterial == Material.lava )
                        {
                        	...
                        	mc.theWorld.playSound((double)((float)var17 + var22), (double)((float)var19 + 0.1F) - Block.blocksList[var20].getBlockBoundsMinY(), (double)((float)var18 + var23), "random.fizz", 0.5F, 2.6F + (mc.theWorld.rand.nextFloat() - mc.theWorld.rand.nextFloat()) * 0.8F, false);
                        }
                        else
                        {
                            ++var14;
                    ...
                    if (var25.canSpawnLightningBolt() || var25.getEnableSnow())
                    {
                        ...
                        if (var27 != var28)
                        {
                            ...
                            if (var42.getWorldChunkManager().getTemperatureAtHeight(var31, var26) >= 0.15F)
                            {
                                ...
                                var33 = (double)((float)var20 + 0.5F) - var41.posZ;
                                float var37 = MathHelper.sqrt_double(var35 * var35 + var33 * var33) / (float)var16;
                                float var38 = 1.0F;
                            ...
                            else
                            {
                                ...
                                var33 = (double)((float)var21 + 0.5F) - var41.posX;
                                double var47 = (double)((float)var20 + 0.5F) - var41.posZ;
                                float var39 = MathHelper.sqrt_double(var33 * var33 + var47 * var47) / (float)var16;
                                float var40 = 1.0F;
                                ...
                                var8.setTranslation(-var9 * 1.0D, -var11 * 1.0D, -var13 * 1.0D);
                                var8.addVertexWithUV((double)((float)var21 - var23) + 0.5D, (double)var27, (double)((float)var20 - var24) + 0.5D, (double)(0.0F * var29 + var46), (double)((float)var27 * var29 / 4.0F + var32 * var29 + var36));
                                var8.addVertexWithUV((double)((float)var21 + var23) + 0.5D, (double)var27, (double)((float)var20 + var24) + 0.5D, (double)(1.0F * var29 + var46), (double)((float)var27 * var29 / 4.0F + var32 * var29 + var36));
                                var8.addVertexWithUV((double)((float)var21 + var23) + 0.5D, (double)var28, (double)((float)var20 + var24) + 0.5D, (double)(1.0F * var29 + var46), (double)((float)var28 * var29 / 4.0F + var32 * var29 + var36));
                                var8.addVertexWithUV((double)((float)var21 - var23) + 0.5D, (double)var28, (double)((float)var20 - var24) + 0.5D, (double)(0.0F * var29 + var46), (double)((float)var28 * var29 / 4.0F + var32 * var29 + var36));
                                var8.setTranslation(0.0D, 0.0D, 0.0D);
                            }
                        }
                    }
    ...
    private void updateFogColor(float par1)
    {
        ...
        float var24 = var2.getRainStrength(par1);
        float var25;
        ...
        float var16 = this.fogColor2 + (this.fogColor1 - this.fogColor2) * par1;
        this.fogColorRed *= var16;
        this.fogColorGreen *= var16;
        this.fogColorBlue *= var16;
        double var17 = var2.provider.getVoidFogYFactor();
        ...
        double var19 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)par1) * var17;

        if (var3.isPotionActive(Potion.blindness))
        {
            int var21 = var3.getActivePotionEffect(Potion.blindness).getDuration();
        ...
        if (var19 < 1.0D)
        {
            ...
            var19 *= var19;
            this.fogColorRed = (float)((double)this.fogColorRed * var19);
            this.fogColorGreen = (float)((double)this.fogColorGreen * var19);
            this.fogColorBlue = (float)((double)this.fogColorBlue * var19);
        }
        ...
        if (var3.isPotionActive(Potion.nightVision))
        {
            ...
            var22 = 1.0F / this.fogColorRed;

            if (var22 > 1.0F / this.fogColorGreen)
            {
                var22 = 1.0F / this.fogColorGreen;
            }

            if (var22 > 1.0F / this.fogColorBlue)
            {
                var22 = 1.0F / this.fogColorBlue;
            }

            this.fogColorRed = this.fogColorRed * (1.0F - var26) + this.fogColorRed * var22 * var26;
            this.fogColorGreen = this.fogColorGreen * (1.0F - var26) + this.fogColorGreen * var22 * var26;
            this.fogColorBlue = this.fogColorBlue * (1.0F - var26) + this.fogColorBlue * var22 * var26;
        }

        if (this.mc.gameSettings.anaglyph)
        {
            var26 = (this.fogColorRed * 30.0F + this.fogColorGreen * 59.0F + this.fogColorBlue * 11.0F) / 100.0F;
            var22 = (this.fogColorRed * 30.0F + this.fogColorGreen * 70.0F) / 100.0F;
            float var23 = (this.fogColorRed * 30.0F + this.fogColorBlue * 70.0F) / 100.0F;
        ...
        else
        {
            ...
            else
            {
                ...
                if (this.cloudFog)
                {
                    ...
                    if (this.mc.gameSettings.anaglyph)
                    {
                        var15 = (var6 * 30.0F + var10 * 59.0F + var11 * 11.0F) / 100.0F;
                ...
                else
                {
                    ...
                    if (var5 > 0 && Block.blocksList[var5].blockMaterial == Material.water)
                    {
                        ...
                        GL11.glFogf(GL11.GL_FOG_DENSITY, var12);
                        var6 = 0.4F;
                        var10 = 0.4F;
                        var11 = 0.9F;
                    ...
                    else
                    {
                        ...
                        GL11.glFogf(GL11.GL_FOG_START, var6 * var12);
                        GL11.glFogf(GL11.GL_FOG_END, var6 * var16);
                    }
                }
            }
