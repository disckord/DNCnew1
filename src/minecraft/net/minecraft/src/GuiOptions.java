...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(269, this.width / 2 + 5,this.height / 6 + 66 - 6, 150, 20, "Perks"));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            if(par1GuiButton.id == 269)
            {
            	  this.mc.gameSettings.saveOptions();
                  this.mc.displayGuiScreen(new GuiPerkOptions(this, this.options));
            }
        }
    }
