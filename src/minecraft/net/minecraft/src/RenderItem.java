...
public class RenderItem extends Render
{
    ...
    public void doRenderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (itemstack.getItem() != null)
        {
            ...
            {
                Block var22 = Block.blocksList[itemstack.itemID];
                ...
                if (var25 == 1 || var25 == 19 || var25 == 12 || var25 == 2 || var25 == 13)
                {
                    var24 = 0.5F;
                }
                ...
                for (var17 = 0; var17 < var13; ++var17)
                {
                    ...
                    var18 = 1.0F;
                    this.itemRenderBlocks.renderBlockAsItem(var22, itemstack.getItemDamage(), var18);
                    GL11.glPopMatrix();
                }
            }
            else
            {
                ...
                if (itemstack.getItem().requiresMultipleRenderPasses())
                {
                    ...
                    {
                        this.random.setSeed(187L);
                        Icon var15 = itemstack.getItem().getIconFromDamageForRenderPass(itemstack.getItemDamage(), var14);
                        var16 = 1.0F;

                        if (this.renderWithColor)
                        {
                            var17 = Item.itemsList[itemstack.itemID].getColorFromItemStack(itemstack, var14);
                ...
                else
                {
                    ...
                    Icon var21 = itemstack.getIconIndex();
                    ...
                    if (this.renderWithColor)
                    {
                        int var23 = Item.itemsList[itemstack.itemID].getColorFromItemStack(itemstack, 0);
