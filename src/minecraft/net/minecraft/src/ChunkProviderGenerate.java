...
public class ChunkProviderGenerate implements IChunkProvider
{
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                    blocks[var43 += var44] = (byte)Block.stone.blockID;
                                }
                                else if (var12 * 8 + var31 < var6)
                                {
                                    blocks[var43 += var44] = (byte)Block.waterStill.blockID;
                                }
                                else
                                {
                                    blocks[var43 += var44] = 0;
                                }
                            }
    ...
    public Chunk provideChunk(int chunkX, int chunkZ)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
            ...
            this.scatteredFeatureGenerator.generate(this, this.worldObj, chunkX, chunkZ, blocks);
        }

        Chunk var4 = new Chunk(this.worldObj, blocks, chunkX, chunkZ);
