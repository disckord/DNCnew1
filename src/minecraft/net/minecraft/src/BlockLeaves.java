...
public class BlockLeaves extends BlockLeavesBase
{
    ...
    public static final String[][] alpha_icon_names = new String[][] {
    	{"alpha_leaves", "alpha_leaves_spruce", "alpha_leaves", "alpha_leaves_jungle"}, 
    
        	{"alpha_leaves_opaque", "alpha_leaves_spruce_opaque", "alpha_leaves_opaque", "alpha_leaves_jungle_opaque"}
};
    private int field_94394_cP;
    private Icon[][] iconArray = new Icon[2][];
    private Icon[][] alphaIconArray = new Icon[2][];
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            if ((par5 & 3) == 0 && par1World.rand.nextInt(1000) == 0)
            {
    ...
    public Icon getIcon(int par1, int par2)
    {
    	...
    	{
    		return (par2 & 3) == 1 ? this.alphaIconArray[this.field_94394_cP][1] : ((par2 & 3) == 3 ? this.alphaIconArray[this.field_94394_cP][3] : this.alphaIconArray[this.field_94394_cP][0]);
    	}
    ...
    {int i;
    int j;
        for ( i = 0; i < field_94396_b.length; ++i)
        {
            this.iconArray[i] = new Icon[field_94396_b[i].length];

            for ( j = 0; j < field_94396_b[i].length; ++j)
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon(field_94396_b[i][j]);
            }
        }
        
        for ( i = 0; i < alpha_icon_names.length; ++i)
        {
            this.alphaIconArray[i] = new Icon[alpha_icon_names[i].length];

            for ( j = 0; j < alpha_icon_names[i].length; ++j)
            {
                this.alphaIconArray[i][j] = par1IconRegister.registerIcon(alpha_icon_names[i][j]);
            }
        }
    }
}
