...
{
    private static List biomelist = Arrays.asList(new BiomeGenBase[] {BiomeGenBase.desert, BiomeGenBase.desertHills, BiomeGenBase.jungle, BiomeGenBase.jungleHills, BiomeGenBase.swampland, BiomeGenBase.BDswampland, BiomeGenBase.BDdesert, BiomeGenBase.BDjungle, BiomeGenBase.BDjungle_nocolor, BiomeGenBase.BDswampland_nocolor});
