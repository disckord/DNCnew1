    ...
    public boolean generate(World var1, Random var2, int var3, int var4, int var5)
    {
        ...
        if (this.generatortype != 0 && this.generatortype != 1)
        {
            ...
            for (var19 = 0; var19 <= this.numberOfBlocks; ++var19)
            {
                ...
                var33 = MathHelper.floor_double(var22 - var30 / 2.0D);
                var34 = MathHelper.floor_double(var24 - var28 / 2.0D);
                int var47 = MathHelper.floor_double(var20 + var28 / 2.0D);
                int var36 = MathHelper.floor_double(var22 + var30 / 2.0D);
                int var48 = MathHelper.floor_double(var24 + var28 / 2.0D);
