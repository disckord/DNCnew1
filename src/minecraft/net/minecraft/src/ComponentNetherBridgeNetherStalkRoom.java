...
public class ComponentNetherBridgeNetherStalkRoom extends ComponentNetherBridgePiece
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        {
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 4, 4, 4, 4, 8, Block.blockNetherQuartz.blockID, Block.blockNetherQuartz.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 8, 4, 4, 9, 4, 8, Block.blockNetherQuartz.blockID, Block.blockNetherQuartz.blockID, false);
        }
        else
        {
        	 this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 4, 4, 4, 4, 8, Block.glowStone.blockID, Block.glowStone.blockID, false);
             this.fillWithBlocks(par1World, par3StructureBoundingBox, 8, 4, 4, 9, 4, 8, Block.glowStone.blockID, Block.glowStone.blockID, false);
        }
