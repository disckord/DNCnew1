...
public class BlockGrass extends Block
{
    ...
    private Icon alphaIconGrassTop;
    private  Icon alphaIconGrassSideOverlay;
    ...
    public Icon getIcon(int par1, int par2)
    {
    	...
    	{
    		 return par1 == 1 ? this.alphaIconGrassTop : (par1 == 0 ? Block.dirt.blockIcon : this.blockIcon);
    	}
        return par1 == 1 ? this.iconGrassTop : (par1 == 0 ? Block.dirt.blockIcon : this.blockIcon);
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.alphaIconGrassSideOverlay = par1IconRegister.registerIcon("alpha_grass_side_overlay");
        alphaIconGrassTop = par1IconRegister.registerIcon("alpha_grass_top");
    ...
    public static Icon getAlphaIconTop()
    {
    	return Block.grass.alphaIconGrassTop;
    }
    public static Icon getIconSideOverlay()
    {
    	if(Config.getGameSettings().alphaFoliage)
    	{
    		return Block.grass.alphaIconGrassSideOverlay;
    	}
