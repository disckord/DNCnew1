...
public class ExtendedBlockStorage
{
    ...
    public int getExtBlockID(int x, int y, int z)
    {
        ...
        return this.blockMSBArray != null ? (this.blockMSBArray.getNibble(x, y, z) * 256) + var4 : var4;
    }
    ...
    public void setExtBlockID(int par1, int par2, int par3, int par4)
    {
        ...
        {
            var5 |= this.blockMSBArray.getNibble(par1, par2, par3) << 8;
        }
    ...
    {
        return this.blockMetadataArray.getNibble(par1, par2, par3);
    }
    ...
    {
        return this.skylightArray.getNibble(par1, par2, par3);
    }
    ...
    {
        return this.blocklightArray.getNibble(par1, par2, par3);
    }
