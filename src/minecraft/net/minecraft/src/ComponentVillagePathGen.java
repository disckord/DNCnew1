...
public class ComponentVillagePathGen extends ComponentVillageRoadPiece
{
    ...
    public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
    {
        ...
        if (var4 && par3Random.nextInt(7) != 0 )
        {
            switch (this.coordBaseMode)
            {
                case 0:
                    StructureVillagePieces.getNextStructureComponentVillagePath((ComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 5, 1, this.getComponentType());
                    break;
                ...
                case 3:
                    StructureVillagePieces.getNextStructureComponentVillagePath((ComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.maxX - 5, this.boundingBox.minY, this.boundingBox.minZ - 1, 2, this.getComponentType());
            }
        }
        ...
        if (var4 && par3Random.nextInt(7) != 0)
        {
            ...
            {
                case 0:
                    StructureVillagePieces.getNextStructureComponentVillagePath((ComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 5, 3, this.getComponentType());
                    break;
                ...
                case 3:
                    StructureVillagePieces.getNextStructureComponentVillagePath((ComponentVillageStartPiece)par1StructureComponent, par2List, par3Random, this.boundingBox.maxX - 5, this.boundingBox.minY, this.boundingBox.maxZ + 1, 0, this.getComponentType());
            }
        }
    }
    ...
    { 
        for (int var7 = 15 * MathHelper.getRandomIntegerInRange(par2Random, 3, 5); var7 >= 15; var7 -= 15)
        {
        	StructureBoundingBox var8  = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5 , 0, 0, 0, 6, 6, var7, par6);
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        int blockid = this.getBiomeSpecificBlock(Block.gravel.blockID, 0);
        ...
        for (int x = this.boundingBox.minX; x <= this.boundingBox.maxX ; ++x)
        {
            for (int z = this.boundingBox.minZ ; z <= this.boundingBox.maxZ; ++z)
            {
                if (par3StructureBoundingBox.isVecInside(x, 64, z))
                {
                	...
                	int y = par1World.getTopSolidOrLiquidBlock(x, z) - 1;
                    if(par2Random.nextInt( 7)!= 0)
                    {
                    par1World.setBlock(x, y, z, blockid, 0, 2);
                    }
                    else if(blockid == Block.gravel.blockID && par2Random.nextInt(20) == 0)
                    {
                    	par1World.setBlock(x, y, z, Block.cobblestoneMossy.blockID, 0, 2);
                    }
                    else if(blockid == Block.gravel.blockID && par2Random.nextInt(7) == 0)
                    {
                    	par1World.setBlock(x, y, z, Block.cobblestone.blockID, 0, 2);
                    }
                }
            }
        }
