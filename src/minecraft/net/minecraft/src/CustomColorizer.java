...
public class CustomColorizer
{
    ...
    public static void update(RenderEngine var0)
    {
        ...
        if (Config.isCustomColors())
        {
            ...
            for (int var2 = 0; var2 < var1.length; ++var2)
            {
                ...
                int[] var4 = getCustomColors(var3, var0, -1);
                var1[var2] = var4 != null ? var4 : getCustomColors("/environment/lightmap0.png", var0, -1);
    ...
    private static void readCustomPalettes(Properties var0, RenderEngine var1)
    {
        ...
        while (var5.hasNext())
        {
            ...
            var6 = var0.getProperty(var7);

            if (var7.startsWith(var18))
            {
                var3.put(var7, var6);
            }
        }

        String[] var19 = (String[])((String[])((String[])var3.keySet().toArray(new String[var3.size()])));
        paletteColors = new int[var19.length][];

        for (int var8 = 0; var8 < var19.length; ++var8)
        {
            var6 = var19[var8];
            String var9 = var0.getProperty(var6);
            Config.log("Block palette: " + var6 + " = " + var9);
            String var10 = var6.substring(var18.length());
            int[] var11 = getCustomColors(var10, var1, 65536);
            paletteColors[var8] = var11;
            String[] var12 = Config.tokenize(var9, " ,;");
            ...
            for (int var13 = 0; var13 < var12.length; ++var13)
            {
                ...
                if (var14.contains(":"))
                {
                    String[] var16 = Config.tokenize(var14, ":");
                    var14 = var16[0];
                    String var17 = var16[1];
                    var15 = Config.parseInt(var17, -1);

                    if (var15 < 0 || var15 > 15)
                    {
                        Config.log("Invalid block metadata: " + var14 + " in palette: " + var6);
                        continue;
                    }
                }

                int var20 = Config.parseInt(var14, -1);
                ...
                if (var20 >= 0 && var20 <= 255)
                {
                    if (var20 != Block.grass.blockID && var20 != Block.tallGrass.blockID && var20 != Block.leaves.blockID && var20 != Block.vine.blockID)
                    {
                        ...
                        else
                        {
                            ...
                            blockPalettes[var20][var15] = var8;
                        }
                    }
                }
                else
                {
                    Config.log("Invalid block index: " + var20 + " in palette: " + var6);
                }
            }
        }
    }
    ...
    public static int getColorMultiplier(Block var0, IBlockAccess var1, int var2, int var3, int var4)
    {
        ...
        else
        {
            ...
            {
                int var8 = var0.blockID;

                if (var8 >= 0 && var8 < 256)
                {
                    int[] var9 = blockPalettes[var8];
                    boolean var10 = true;
                    int var11;
            ...
            boolean var12 = Config.isSwampColors();
            boolean var13 = false;
            byte var14 = 0;
            var7 = 0;
            ...
            if (var13)
            {
                return getSmoothColorMultiplier(var0, var1, var2, var3, var4, var5, var6, var14, var7);
            }
            else
            {
    ...
    public static int getSmoothColor(int[] var0, IBlockAccess var1, double var2, double var4, double var6, int var8, int var9)
    {
        ...
        else
        {
            ...
            for (var19 = var10 - var13; var19 <= var10 + var13; var19 += var9)
            {
                for (var18 = var12 - var13; var18 <= var12 + var13; var18 += var9)
                {
                    var20 = getCustomColor(var0, var1, var19, var11, var18);
                    var14 += var20 >> 16 & 255;
                    var15 += var20 >> 8 & 255;
                    var16 += var20 & 255;
                    ++var17;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (var8 < 16)
                        {
                            ...
                            lightMapsColorsRgb[var5] = (float[][])((float[][])null);
                            return false;
                        }
                        else
                        {
                            ...
                            float var12 = Config.limitTo1( 0.5F * (float)(var8 - 1));
